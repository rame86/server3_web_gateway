...
export default function UserLogin() {
    ...
    const sendVerificationCode = async () => {
        ...
        try {
            ...
            const response = await axios.post(`http://localhost/msa/core/member/SendVerification?email=${formData.email}`);
    ...
    const handleSocialLogin = (provider) => {
        ...
        window.location.href = `http://localhost/msa/core/api/login/${provider}`;
    };
    ...
    const handleLocalLogin = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost/msa/core/member/login', {
